	...
	if(!$(menuid)) {
		switch(tag) {
			case 'at':
				...
				str = '请输用户名:<br /><input type="text" id="atkeyword" style="width:213px" value="" class="px" onkeydown="atFilter(this.value, \'at_list\',\'atListSet\',event);" /><div class="p_pop" id="at_list" style="width:230px;"><ul><li>@朋友账号，就能提醒他来看帖子</li></ul></div>';
		...
		menu.innerHTML = '<span class="y"><a onclick="hideMenu()" class="flbc" href="javascript:;">关闭</a></span><div class="p_opt cl"><form onsubmit="' + submitstr + ';return false;" autocomplete="off"><div>' + str + '</div><div class="pns mtn"><button type="submit" id="' + ctrlid + '_submit" class="bluesmallbutton"><strong>提交</strong></button><button type="button" onClick="hideMenu()" class="whitesmallbutton"><em>取消</em></button></div></form></div>';
	}
